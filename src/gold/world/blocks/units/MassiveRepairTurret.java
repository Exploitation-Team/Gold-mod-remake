package gold.world.blocks.units;
...
public class MassiveRepairTurret extends RepairTurret {
    ...
    public MassiveRepairTurret(String name){
        super(name);
        update = true;
        solid = true;
    }
    ...
    public class RepairTowerBuild extends RepairPointBuild implements Ranged{
