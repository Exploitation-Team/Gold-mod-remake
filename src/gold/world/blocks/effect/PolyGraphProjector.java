package gold.world.blocks.effect;
...
public class PolyGraphProjector extends Block{
    ...
    public Effect shieldBreakEffect = GMRFx.polyShieldBreak;
    ...
    public PolyGraphProjector(String name){
        super(name);
        update = true;
        solid = true;
    ...
    public void drawPlace(int x, int y, int rotation, boolean valid){
        ...
        Draw.color(Pal.gray);
        Lines.stroke(3f);
        Lines.poly(x * tilesize + offset, y * tilesize + offset, 4, radius);
        Draw.color(player.team().color);
        Lines.stroke(1f);
        Lines.poly(x * tilesize + offset, y * tilesize + offset, 4, radius);
        Draw.color(Pal.gray);
        Lines.stroke(3f);
        Lines.poly(x * tilesize + offset, y * tilesize + offset, 4, radius, 45);
        Draw.color(player.team().color);
        Lines.stroke(1f);
        Lines.poly(x * tilesize + offset, y * tilesize + offset, 4, radius, 45);
        Draw.color();
    ...
    public class ForceBuild extends Building implements Ranged{
        ...
        public void onRemoved(){
            ...
            if(!broken && radius > 1f) GMRFx.polyForceShrink.at(x, y, radius, team.color);
            super.onRemoved();
        }
