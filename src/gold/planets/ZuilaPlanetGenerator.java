...
public class ZuilaPlanetGenerator extends PlanetGenerator{
    ...
    Block[][] arr =
            {
                    {Blocks.deepwater, GMRBlocks.darksandTarred, GMRBlocks.sandTarred, Blocks.sand, Blocks.stone, Blocks.sand, Blocks.sand, Blocks.basalt, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass},
                    {Blocks.deepwater, GMRBlocks.darksandTarred, GMRBlocks.sandTarred, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.metalFloorDamaged, Blocks.dacite, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass},
                    {Blocks.deepwater, GMRBlocks.sandTarred, Blocks.sand, Blocks.sand, Blocks.metalFloorDamaged, Blocks.metalFloorDamaged, Blocks.grass, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.grass, Blocks.grass, Blocks.grass},
                    {Blocks.tar, GMRBlocks.darksandTarred, Blocks.darksand, Blocks.darksand, Blocks.basalt, Blocks.metalFloorDamaged, Blocks.basalt, Blocks.hotrock, Blocks.basalt, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass},
                    {GMRBlocks.darksandTarred, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.metalFloorDamaged, Blocks.tar, Blocks.grass, Blocks.basalt, Blocks.basalt, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass},
                    {GMRBlocks.darksandTarred, Blocks.stone, Blocks.darksand, Blocks.tar, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass},
                    {Blocks.tar, GMRBlocks.darksandTarred, Blocks.darksand, Blocks.tar, Blocks.tar, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass},
                    {GMRBlocks.darksandTarred, GMRBlocks.darksandTarred, Blocks.darksand, Blocks.tar, Blocks.metalFloorDamaged, Blocks.tar, Blocks.dacite, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass},
                    {GMRBlocks.darksandTarred, Blocks.darksand, Blocks.grass, Blocks.grass, Blocks.dacite, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass, Blocks.grass},
                    {GMRBlocks.darksandTarred, GMRBlocks.darksandTarred, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.sand, GMRBlocks.darksandTarred, Blocks.stone, Blocks.stone},
                    {GMRBlocks.darksandTarred, GMRBlocks.darksandTarred, Blocks.darksand, Blocks.darksand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.sand, GMRBlocks.darksandTarred, Blocks.stone, Blocks.stone, Blocks.stone},
                    {GMRBlocks.darksandTarred, GMRBlocks.darksandTarred, Blocks.darksand, Blocks.sand, Blocks.stone, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.sand, GMRBlocks.darksandTarred, Blocks.stone, Blocks.stone, Blocks.stone},
                    {GMRBlocks.darksandTarred, GMRBlocks.sandTarred, Blocks.sand, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.sand, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.grass, Blocks.dacite, Blocks.grass}
            };
    {
        baseSeed = 3;
    ...
    protected void generate(){
                        ...
                        for(int y = -rad; y <= rad; y++){
                            ...
                            if(Structs.inBounds(wx, wy, width, height) && Mathf.within(x, y, rad)){
                                ...
                                if(Mathf.within(x, y, rad - 1) && !other.floor().isLiquid){
                                    ...
                                    other.setFloor((Floor)(floor == Blocks.sand || floor == Blocks.salt ? GMRBlocks.darksandTarred : Blocks.tar));
                                }
                            }
                        }
                    }
        ...
        pass((x, y) -> {
            ...
            if(value > 0.17f && !Mathf.within(x, y, fspawn.x, fspawn.y, 12 + rrscl)){
                ...
                if(!(floor == Blocks.ice || floor == Blocks.iceSnow || floor == Blocks.snow || floor.asFloor().isLiquid)){
                    floor = spore ?
                            (deep ? Blocks.tar : GMRBlocks.darksandTarred) :
                            (deep ? Blocks.tar :
                                    (floor == Blocks.darksand || floor == Blocks.salt ? GMRBlocks.darksandTarred : Blocks.tar));
                }
            }
        });
        ...
        pass((x, y) -> {
            ...
            if(floor.asFloor().isLiquid && floor.asFloor().shallow){
                ...
                floor = floor == Blocks.darksand ? GMRBlocks.darksandTarred : Blocks.tar;
            }
        });
        ...
        if(Simplex.noise3d(seed, 2, 0.5, scl, sector.tile.v.x + 1, sector.tile.v.y, sector.tile.v.z)*nmag + poles > 0.3f*addscl){
        ...
        pass((x, y) -> {
            ...
            if(floor == Blocks.hotrock){
                ...
                if(noise > 0.67f && !roomseq.contains(e -> Mathf.within(x, y, e.x, e.y, 14))){
                    if(noise > 0.72f){
                        floor = noise > 0.78f ? Blocks.tar : (floor == Blocks.sand ? GMRBlocks.sandTarred : GMRBlocks.darksandTarred);
                    }else{
