...
public class GMRAsteroidsGenerator extends BlankPlanetGenerator{
    public int min = 20, max = 30, octaves = 2, foct = 3;
    public float radMin = 11f, radMax = 57f, persistence = 0.4f, scale = 30f, mag = 0.46f, thresh = 1f;
    public float fmag = 0.5f, fscl = 50f, fper = 0.6f;
    public float iceChance = 0f, carbonChance = 0f, goldChance = 0.5f, crystalChance = 0.4f;

    public float thoriumScl = 1f, leadScale = 1f, graphiteScale = 1f, goldScale = 1f;

    @Nullable Rand rand;
    int seed;

    {
        defaultLoadout = GMRLoadouts.basicSolar;
    }
        ...
        Floor floor = (
                rand.chance(iceChance) ? Blocks.ice :
                        rand.chance(carbonChance) ? Blocks.carbonStone :
                                rand.chance(goldChance) ? GMRBlocks.goldStone :
                                        rand.chance(crystalChance) ? Blocks.crystalFloor :
                                                Blocks.stone
        ).asFloor();
    ...
    public void generate(){
        ...
        ore(Blocks.oreThorium, Blocks.crystalFloor, 4f, 0.9f * thoriumScl);
        ...
        ore(GMRBlocks.goldOre, GMRBlocks.goldStone, 4f, 0.9f * goldScale);
